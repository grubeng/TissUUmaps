...
interfaceUtils.removeOptionFromSelect = function (domid, key) {
  ...
  if (select) {
    ...
    for (var i = 0; i < select.length; i++) {
      if (select.options[i].value == key) remove = i;
    }
...
interfaceUtils.checkSelectNotZero = function (domid) {
  ...
  if (selector) {
    ...
    if (key.toString() == "0") return false;
    return true;
  } else {
    console.log("Element with id " + domid + " doesn't exist");
    return null;
...
interfaceUtils.hideTabsExcept = function (a) {
  ...
  if (closestul !== null) {
    closestul[0].classList.forEach(function (v) {
      var arr = regex1.exec(v);
      if (arr !== null) level = Number(arr[1]);
    });
  } else {
...
interfaceUtils.toggleRightPanel = function (a) {
  ...
  setTimeout(function () {
    tmapp[vname].viewport.applyConstraints(true);
  }, 100);
};
...
interfaceUtils.generateDataTabUI = function (options) {
  ...
  if (!dataUtils.data[generated]) {
    ...
    togglerow = HTMLElementUtils.createElement({
      kind: "div",
      extraAttributes: { class: "row" },
    });
    var divpane_settings_toggle = HTMLElementUtils.createElement({
      kind: "div",
      id: generated + "_marker-tab-settings-toggle",
      extraAttributes: {
        class: "d-none w-auto ms-auto btn btn-light btn-sm mx-3",
      },
    });
    divpane_settings_toggle.innerHTML = "<i class='bi bi-sliders'></i>";
    divpane_settings_toggle.addEventListener("click", function (event) {
      var divpane_settings = interfaceUtils.getElementById(
        generated + "_marker-tab-settings"
      );
      divpane_settings.classList.remove("d-none");
      divpane_settings_toggle.classList.add("d-none");
    });
    var divpane_settings = HTMLElementUtils.createElement({
      kind: "div",
      id: generated + "_marker-tab-settings",
    });
    ...
    row0 = HTMLElementUtils.createRow({
      id: generated + "_csv_progress_parent",
    });
    ...
    div011 = HTMLElementUtils.createElement({
      kind: "div",
      extraAttributes: { class: "progress" },
    });
    div0111 = HTMLElementUtils.createElement({
      kind: "div",
      id: generated + "_csv_progress",
      extraAttributes: {
    ...
    if (tabs1content) tabs1content.appendChild(divpane);
      ...
      console.log("No level 1 tab content");
      return;
    }
  }
  ...
  if (options) {
    ...
    if (options.hideSettings) {
      divpane_settings = interfaceUtils.getElementById(
        generated + "_marker-tab-settings"
      );
      divpane_settings.classList.add("d-none");
      divpane_settings_toggle = interfaceUtils.getElementById(
        generated + "_marker-tab-settings-toggle"
      );
...
interfaceUtils._mGenUIFuncs.intputToH5 = function (uid, inputDropDown) {
  ...
  let options = {
    ...
    lookup: function (query, done) {
      ...
      dataUtils._hdf5Api.getKeys(url, query).then(
        (data) => {
          let keys = data.children.map(
            (value) => {
...
interfaceUtils._mGenUIFuncs.ChangeTabName = function (uid, value) {
  ...
  if (domelement) {
    if (value) domelement.innerText = value;
    else domelement.innerText = uid;
    domelement.setAttribute("title", domelement.innerText);
    interfaceUtils.getElementById(uid + "_tab-name").value =
...
interfaceUtils._mGenUIFuncs.getTabDropDowns = function (uid, only_csvColumns) {
  ...
  allinputs["opacity_col"] = interfaceUtils.getElementById(
    uid + "_opacity-col"
  );
  allinputs["shape_col"] = interfaceUtils.getElementById(
    uid + "_shape-col-value"
  );
  allinputs["collectionItem_col"] = interfaceUtils.getElementById(
    uid + "_collectionItem-col-value"
  );
  if (!only_csvColumns) {
    allinputs["z_order"] = interfaceUtils.getElementById(uid + "_z-order");
    allinputs["cb_gr_dict"] = interfaceUtils.getElementById(
      uid + "_cb-bygroup-dict-val"
    );
    allinputs["cb_cmap"] = interfaceUtils.getElementById(
      uid + "_cb-cmap-value"
    );
    allinputs["scale_factor"] = interfaceUtils.getElementById(
      uid + "_scale-factor"
    );
    allinputs["coord_factor"] = interfaceUtils.getElementById(
      uid + "_coord-factor"
    );
    allinputs["pie_dict"] = interfaceUtils.getElementById(
      uid + "_piechart-dict-val"
    );
    allinputs["shape_fixed"] = interfaceUtils.getElementById(
      uid + "_shape-fixed-value"
    );
    allinputs["shape_gr_dict"] = interfaceUtils.getElementById(
      uid + "_shape-bygroup-dict-val"
    );
    allinputs["opacity"] = interfaceUtils.getElementById(uid + "_opacity");
    allinputs["tooltip_fmt"] = interfaceUtils.getElementById(
      uid + "_tooltip_fmt"
    );
    allinputs["collectionItem_fixed"] = interfaceUtils.getElementById(
      uid + "_collectionItem-fixed-value"
    );
  }
  return allinputs;
};
...
interfaceUtils._mGenUIFuncs.getTabRadiosAndChecks = function (uid) {
  ...
  allradios["cb_gr_rand"] = interfaceUtils.getElementById(
    uid + "_cb-bygroup-rand"
  );
  allradios["cb_gr_dict"] = interfaceUtils.getElementById(
    uid + "_cb-bygroup-dict"
  );
  allradios["cb_gr_key"] = interfaceUtils.getElementById(
    uid + "_cb-bygroup-key"
  );

  allradios["pie_check"] = interfaceUtils.getElementById(
    uid + "_use-piecharts"
  );
  allradios["edges_check"] = interfaceUtils.getElementById(uid + "_use-edges");
  allradios["sortby_check"] = interfaceUtils.getElementById(
    uid + "_use-sortby"
  );
  allradios["sortby_desc_check"] = interfaceUtils.getElementById(
    uid + "_sortby-desc"
  );
  ...
  allradios["shape_gr_rand"] = interfaceUtils.getElementById(
    uid + "_shape-bygroup-rand"
  );
  allradios["shape_gr_dict"] = interfaceUtils.getElementById(
    uid + "_shape-bygroup-dict"
  );
  allradios["shape_col"] = interfaceUtils.getElementById(
    uid + "_shape-bypoint"
  );
  allradios["shape_fixed"] = interfaceUtils.getElementById(
    uid + "_shape-fixed"
  );
  allradios["opacity_check"] = interfaceUtils.getElementById(
    uid + "_use-opacity"
  );
  allradios["_no_outline"] = interfaceUtils.getElementById(
    uid + "__no-outline"
  );
  allradios["collectionItem_col"] = interfaceUtils.getElementById(
    uid + "_collectionItem-bypoint"
  );
  allradios["collectionItem_fixed"] = interfaceUtils.getElementById(
    uid + "_collectionItem-fixed"
  );
...
interfaceUtils._mGenUIFuncs.generateTab = function () {
  ...
  li1 = HTMLElementUtils.createElement({
    kind: "li",
    id: generated + "_li-tab",
    extraAttributes: { class: "nav-item", role: "presentation" },
  });
  button1 = HTMLElementUtils.createButton({
    id: generated + "_marker-tab-button",
    extraAttributes: {
      class: "nav-link marker-tab-button",
      "data-bs-toggle": "tab",
  ...
  span1 = HTMLElementUtils.createElement({
    kind: "span",
    id: generated + "_marker-tab-name",
    extraAttributes: { title: "New markers" },
  });
  span1.innerHTML = "New markers";

  button1.appendChild(span1);
  closeButton = HTMLElementUtils.createElement({
    kind: "a",
    id: generated + "_marker-tab-close",
  });
...
interfaceUtils._mGenUIFuncs.generateAccordion = function () {
  ...
  accordionitems = [];
  accordioncontents = [];
  ["File and coordinates", "Render options", "Advanced options"].forEach(
    function (title, index) {
      ...
      buttonaccordionitem = HTMLElementUtils.createElement({
        ...
        extraAttributes: {
          ...
          "data-bs-target":
            "#" + generated + "_flush-collapse" + index.toString(),
          "aria-expanded": "false",
          "aria-controls": generated + "_flush-collapse" + index.toString(),
        },
      });
      divaccordioncontent = HTMLElementUtils.createElement({
        kind: "div",
        id: generated + "_flush-collapse" + index.toString(),
        extraAttributes: {
          class: "accordion-collapse collapse tm-accordion-collapse py-2",
  ...
  accordionitems.forEach((ait) => {
    divaccordion.appendChild(ait);
  });
...
interfaceUtils._mGenUIFuncs.generateAccordionItem1 = function () {
  ...
  col11 = HTMLElementUtils.createColumn({
    width: 6,
    id: generated + "_input_csv_col",
  });
  ...
  label1111 = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: { for: generated + "_csv" },
  });
  ...
  input1112 = HTMLElementUtils.createElement({
    ...
    extraAttributes: {
      ...
      type: "file",
      accept: ".csv,.tsv,.txt,.h5,.h5ad",
    },
  });
  input1112.addEventListener("change", (event) => {
    dataUtils.startCSVcascade(event);
  });
  ...
  input1222.addEventListener("change", (event) => {
    interfaceUtils._mGenUIFuncs.ChangeTabName(
  ...
  label211 = HTMLElementUtils.createElement({
    ...
    extraAttributes: { for: generated + "_x-value" },
  });
  ...
  label221 = HTMLElementUtils.createElement({
    ...
    extraAttributes: { for: generated + "_y-value" },
  });
  ...
  label301 = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_coord-factor",
    },
  });
  label301.innerHTML = "Coordinate scale factor";
  inputscalefactor = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_coord-factor",
    extraAttributes: {
...
interfaceUtils._mGenUIFuncs.generateColorByAccordion2 = function () {
  ...
  inputradio1cb = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_cb-bygroup",
    extraAttributes: {
      name: generated + "_flexRadioColorBy",
  ...
  divoptionscolgroup = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_cb-col-group-options",
    extraAttributes: { class: "renderOptionContainer" },
  });

  rowkey = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_row-cb-gr-key",
    extraAttributes: { class: "form-check" },
  });
  inputradiocbgrkey = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_cb-bygroup-key",
    extraAttributes: {
      name: generated + "_flexRadioColorByGroup",
      class: "form-check-input",
      type: "radio",
      checked: true,
    },
  });
  labelcbgroupkey = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_cb-bygroup-key",
    },
  });
  labelcbgroupkey.innerHTML = "Generate color from key value<br>";

  rowrand = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_row-cb-gr-rand",
    extraAttributes: { class: "form-check" },
  });
  inputradiocbgrrand = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_cb-bygroup-rand",
    extraAttributes: {
      name: generated + "_flexRadioColorByGroup",
      class: "form-check-input",
      type: "radio",
  ...
  labelcbgrouprand = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_cb-bygroup-rand",
    },
  });
  labelcbgrouprand.innerHTML = "Generate color randomly<br>";

  rowdict = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_row-cb-gr-dict",
    extraAttributes: { class: "form-check" },
  });
  inputradiocbgrdict = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_cb-bygroup-dict",
    extraAttributes: {
      name: generated + "_flexRadioColorByGroup",
      class: "form-check-input",
      type: "radio",
  ...
  labelcbgroupdict = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_cb-bygroup-dict",
    },
  });
  labelcbgroupdict.innerHTML = "Use color from dictionary<br>";
  inputtextcbgrdict = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_cb-bygroup-dict-val",
    extraAttributes: {
      class: "form-text-input",
      type: "text",
      placeholder: '{"key1":"#FFFFFF",...}',
    },
  });
  ...
  divoptionscol = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_cb-col-options",
    extraAttributes: { class: "renderOptionContainer d-none" },
  });
  selectcbcol = HTMLElementUtils.createElement({
    kind: "select",
    id: generated + "_cb-col-value",
    extraAttributes: {
      class: "form-select form-select-sm",
      "aria-label": ".form-select-sm",
    },
  ...
  labelcbcol = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_cb_col-colname-label",
    extraAttributes: { for: generated + "_cb-col-value" },
  });
  labelcbcol.innerText = "Select color column";
  divoptionscmap = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_cb-cmap-options",
    extraAttributes: { class: "renderOptionContainer d-none" },
  });
  labelcbcmapvalue = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_cb-cmap-label",
    extraAttributes: { for: generated + "_cb-cmap-value" },
  });
  labelcbcmapvalue.innerText = "Color map (only if color column is numeral)";
  cmapoptions = [{ text: "None", value: "" }];
  dataUtils._d3LUTs.forEach((lut) => {
    cmapoptions.push({ text: lut.replace("interpolate", ""), value: lut });
  });
  selectcbcmap = HTMLElementUtils.selectTypeDropDown({
    id: generated + "_cb-cmap-value",
    class: "form-select form-select-sm",
    options: cmapoptions,
    extraAttributes: { "aria-label": ".form-select-sm" },
  });

  //listeners

  inputradio1cb.addEventListener("change", (event) => {
    interfaceUtils._mGenUIFuncs.hideShow(
      event,
      ["_cb-cmap-options", "_cb-col-options", "_cb-col-group-options"],
      [2]
    );
  });
...
interfaceUtils._mGenUIFuncs.generateKeyColAccordion2 = function () {
  ...
  labellab = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_cb-label",
  });
  ...
  label010 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_key-col-label",
    extraAttributes: { for: generated + "_key-col" },
  });
  label010.innerText = "Key to group by (optional)";
  select011 = HTMLElementUtils.createElement({
    kind: "select",
    id: generated + "_gb-col-value",
    extraAttributes: {
      class: "form-select form-select-sm",
      "aria-label": ".form-select-sm",
    },
  ...
  label012 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_name-col-label",
    extraAttributes: { for: generated + "_name-col" },
  });
  label012.innerText = "Extra column to display (optional)";
  select013 = HTMLElementUtils.createElement({
    kind: "select",
    id: generated + "_gb-col-name",
    extraAttributes: {
      class: "form-select form-select-sm",
      "aria-label": ".form-select-sm",
    },
...
interfaceUtils._mGenUIFuncs.generateAdvancedScaleAccordion3 = function () {
  ...
  col00 = HTMLElementUtils.createColumn({ width: 6 });
  label0002 = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_scale-factor",
    },
  });
  label0002.innerHTML = "Size factor:&nbsp;";
  inputsizefactor = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_scale-factor",
    extraAttributes: {
      class: "form-text-input",
      type: "number",
      value: 1,
  ...
  divformcheck000 = HTMLElementUtils.createElement({
    kind: "div",
    extraAttributes: { class: "form-check" },
  });
  inputcheck0000 = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_use-scales",
    extraAttributes: { class: "form-check-input", type: "checkbox" },
  });
  label0001 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_use-scales-label",
    extraAttributes: { for: generated + "_use-scales" },
  });
  ...
  label010 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_scale-col-label",
    extraAttributes: { for: generated + "_scale-col", class: "d-none" },
  });
  label010.innerText = "Size column";
  select011 = HTMLElementUtils.createElement({
    kind: "select",
    id: generated + "_scale-col",
    extraAttributes: {
...
interfaceUtils._mGenUIFuncs.generateAdvancedShapeAccordion3 = function () {
  ...
  labellab = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_shape-label",
  });
  labellab.innerHTML = "<strong>Marker shape</strong>";

  colshape2 = HTMLElementUtils.createColumn({ width: 6 });
  divformcheck1shape = HTMLElementUtils.createElement({
    kind: "div",
    extraAttributes: { class: "form-check" },
  });
  inputradio1shape = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_shape-bygroup",
    extraAttributes: {
      name: generated + "_flexRadioShapeBy",
      class: "form-check-input",
      type: "radio",
      checked: true,
    },
  });
  labelshapegroup = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_shape-bygroup",
    },
  });
  labelshapegroup.innerText = "Shape by group";

  divformcheck2shape = HTMLElementUtils.createElement({
    kind: "div",
    extraAttributes: { class: "form-check" },
  });
  inputradio2shape = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_shape-bypoint",
    extraAttributes: {
      name: generated + "_flexRadioShapeBy",
      class: "form-check-input",
      type: "radio",
  ...
  labelshapepoint = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_shape-bypoint",
    },
  });
  labelshapepoint.innerText = "Shape by marker";

  divformcheck3shape = HTMLElementUtils.createElement({
    kind: "div",
    extraAttributes: { class: "form-check" },
  });
  inputradio3shape = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_shape-fixed",
    extraAttributes: {
      name: generated + "_flexRadioShapeBy",
      class: "form-check-input",
      type: "radio",
  ...
  labelshapefixed = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_shape-fixed",
    },
  });
  labelshapefixed.innerText = "Use a fixed shape";

  divformcheck4shape = HTMLElementUtils.createElement({
    kind: "div",
    extraAttributes: { class: "form-check" },
  });
  inputcheck4shape = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "__no-outline",
    extraAttributes: { class: "form-check-input", type: "checkbox" },
  });
  label4shape = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "__no-outline-label",
    extraAttributes: { for: generated + "__no-outline" },
  });
  ...
  divoptionscolgroup = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_shape-col-group-options",
    extraAttributes: { class: "renderOptionContainer" },
  });

  rowrand = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_row-shape-gr-rand",
    extraAttributes: { class: "form-check" },
  });
  inputradioshapegrrand = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_shape-bygroup-rand",
    extraAttributes: {
      name: generated + "_flexRadioShapeByGroup",
      class: "form-check-input",
      type: "radio",
      checked: true,
    },
  });
  labelshapegrouprand = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_shape-bygroup-rand",
    },
  });
  ...
  rowdict = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_row-shape-gr-dict",
    extraAttributes: { class: "form-check" },
  });
  inputradioshapegrdict = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_shape-bygroup-dict",
    extraAttributes: {
      name: generated + "_flexRadioShapeByGroup",
      class: "form-check-input",
      type: "radio",
  ...
  labelshapegroupdict = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_shape-bygroup-dict",
    },
  });
  labelshapegroupdict.innerHTML = "Use shape from dictionary<br>";
  inputtextshapegrdict = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_shape-bygroup-dict-val",
    extraAttributes: {
      class: "form-text-input",
      type: "text",
      placeholder: '{"key1":"disc",...}',
    },
  });
  ...
  divoptionscol = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_shape-col-options",
    extraAttributes: { class: "renderOptionContainer d-none" },
  });
  selectshapecol = HTMLElementUtils.createElement({
    kind: "select",
    id: generated + "_shape-col-value",
    extraAttributes: {
      class: "form-select form-select-sm",
      "aria-label": ".form-select-sm",
    },
  });
  labelshapecol = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_shape_col-colname-label",
    extraAttributes: { for: generated + "_shape-col-value" },
  });
  labelshapecol.innerText = "Select shape column";

  divoptionsfixed = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_shape-fixed-options",
    extraAttributes: { class: "renderOptionContainer d-none" },
  });
  labelfixedshapevalue = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_shape-fixed-label",
    extraAttributes: { for: generated + "_shape-fixed-value" },
  });
  labelfixedshapevalue.innerText = "Select shape";
  shapeoptions = [];
  markerUtils._symbolStrings.forEach((sho, shoIndex) => {
    shapeoptions.push({
      text: markerUtils._symbolUnicodes[shoIndex],
      value: sho,
    });
  });
  shapeinput2 = HTMLElementUtils.selectTypeDropDown({
    id: generated + "_shape-fixed-value",
    class: "form-select form-select-sm",
  ...
  inputradio1shape.addEventListener("change", (event) => {
    interfaceUtils._mGenUIFuncs.hideShow(
      ...
      [
        "_shape-col-options",
        "_shape-col-group-options",
        "_shape-fixed-options",
      ],
      [1]
    );
  });
...
interfaceUtils._mGenUIFuncs.generateAdvancedCollectionAccordion3 = function () {
  ...
  labellab = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_collectionItem-label",
  });
  labellab.innerHTML = "<strong>Collection mode</strong>";

  colcollectionItem2 = HTMLElementUtils.createColumn({ width: 6 });

  divformcheck2collectionItem = HTMLElementUtils.createElement({
    kind: "div",
    extraAttributes: { class: "form-check" },
  });
  inputradio2collectionItem = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_collectionItem-fixed",
    extraAttributes: {
      name: generated + "_flexRadioCollectionBy",
      class: "form-check-input",
      type: "radio",
      checked: true,
    },
  });
  labelcollectionItemfixed = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_collectionItem-fixed",
    },
  });
  labelcollectionItemfixed.innerText = "Use a fixed collection item";

  divformcheck3collectionItem = HTMLElementUtils.createElement({
    kind: "div",
    extraAttributes: { class: "form-check" },
  });
  inputradio3collectionItem = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_collectionItem-bypoint",
    extraAttributes: {
      name: generated + "_flexRadioCollectionBy",
      class: "form-check-input",
      type: "radio",
  ...
  labelcollectionItempoint = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_collectionItem-bypoint",
    },
  });
  ...
  divoptionsfixed = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_collectionItem-fixed-options",
    extraAttributes: { class: "renderOptionContainer" },
  });
  labelfixedcollectionItemvalue = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_collectionItem-fixed-label",
    extraAttributes: { for: generated + "_collectionItem-fixed-value" },
  });
  labelfixedcollectionItemvalue.innerText = "Specify collection item index";
  collectionIteminput2 = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_collectionItem-fixed-value",
    extraAttributes: {
      class: "form-text-input",
      type: "number",
      value: 0,
  ...
  divoptionscol = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_collectionItem-col-options",
    extraAttributes: { class: "renderOptionContainer d-none" },
  });
  selectcollectionItemcol = HTMLElementUtils.createElement({
    kind: "select",
    id: generated + "_collectionItem-col-value",
    extraAttributes: {
      class: "form-select form-select-sm",
      "aria-label": ".form-select-sm",
    },
  });
  labelcollectionItemcol = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_collectionItem_col-colname-label",
    extraAttributes: { for: generated + "_collectionItem-col-value" },
  });
  ...
  inputradio2collectionItem.addEventListener("change", (event) => {
    interfaceUtils._mGenUIFuncs.hideShow(
      event,
      [
        "_collectionItem-col-options",
        "_collectionItem-col-group-options",
        "_collectionItem-fixed-options",
      ],
      [2]
    );
  });
...
interfaceUtils._mGenUIFuncs.generateAdvancedPiechartAccordion3 = function () {
  ...
  inputcheck0000 = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_use-piecharts",
    extraAttributes: { class: "form-check-input", type: "checkbox" },
  });
  label0001 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_use-piecharts-label",
    extraAttributes: { for: generated + "_use-piecharts" },
  });
  ...
  label010 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_piechart-col-label",
    extraAttributes: { class: "d-none", for: generated + "_piechart-col" },
  });
  label010.innerText = "Pie-chart column";
  select011 = HTMLElementUtils.createElement({
    kind: "select",
    id: generated + "_piechart-col",
    extraAttributes: {
      class: "d-none form-select form-select-sm",
      "aria-label": ".form-select-sm",
    },
  });
  select011.disabled = true;
  label012 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_piechart-dict-label",
    extraAttributes: { class: "d-none", for: generated + "_piechart-dict" },
  });
  label012.innerText = "Pie-chart colors";
  input013 = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_piechart-dict-val",
    extraAttributes: {
      class: "d-none form-text-input",
      type: "text",
      placeholder: '{"key1":"#FFFFFF",...}',
    },
  });
...
interfaceUtils._mGenUIFuncs.generateAdvancedEdgesAccordion3 = function () {
  ...
  inputcheck0000 = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_use-edges",
    extraAttributes: { class: "form-check-input", type: "checkbox" },
  });
  label0001 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_use-edges-label",
    extraAttributes: { for: generated + "_use-edges" },
  });
  ...
  label010 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_edges-col-label",
    extraAttributes: { class: "d-none", for: generated + "_edges-col" },
  });
  label010.innerText = "Edges column";
  select011 = HTMLElementUtils.createElement({
    kind: "select",
    id: generated + "_edges-col",
    extraAttributes: {
      class: "d-none form-select form-select-sm",
      "aria-label": ".form-select-sm",
    },
...
interfaceUtils._mGenUIFuncs.generateAdvancedOpacityAccordion3 = function () {
  ...
  label0002 = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: { class: "form-check-label", for: generated + "_opacity" },
  });
  label0002.innerHTML = "Opacity value:&nbsp;";
  inputsizefactor = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_opacity",
    extraAttributes: {
      class: "form-text-input",
      type: "number",
      value: 1,
  ...
  inputcheck0000 = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_use-opacity",
    extraAttributes: { class: "form-check-input", type: "checkbox" },
  });
  label0001 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_use-opacity-label",
    extraAttributes: { for: generated + "_use-opacity" },
  });
  ...
  label010 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_opacity-col-label",
    extraAttributes: { for: generated + "_opacity-col", class: "d-none" },
  });
  label010.innerText = "Opacity column";
  select011 = HTMLElementUtils.createElement({
    kind: "select",
    id: generated + "_opacity-col",
    extraAttributes: {
      class: "form-select form-select-sm d-none",
      "aria-label": ".form-select-sm",
    },
  ...
  inputcheck0000.addEventListener("change", (event) => {
    ...
    if (value) {
      ...
      interfaceUtils._mGenUIFuncs.hideShow(
        event,
        ["_opacity-col", "_opacity-col-label"],
        [0, 1]
      );
    } else {
...
interfaceUtils._mGenUIFuncs.generateAdvancedSortbyAccordion3 = function () {
  ...
  inputcheck0000 = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_use-sortby",
    extraAttributes: { class: "form-check-input", type: "checkbox" },
  });
  label0001 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_use-sortby-label",
    extraAttributes: { for: generated + "_use-sortby" },
  });
  ...
  label010 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "_sortby-col-label",
    extraAttributes: { class: "d-none", for: generated + "_sortby-col" },
  });
  label010.innerText = "Sort by column";
  select011 = HTMLElementUtils.createElement({
    kind: "select",
    id: generated + "_sortby-col",
    extraAttributes: {
      class: "d-none form-select form-select-sm",
      "aria-label": ".form-select-sm",
    },
  });
  divformcheck012 = HTMLElementUtils.createElement({
    kind: "div",
    id: generated + "_sortby-desc-div",
    extraAttributes: { class: "d-none form-check" },
  });
  inputcheck0120 = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_sortby-desc",
    extraAttributes: { class: "form-check-input", type: "checkbox" },
  });
  label0121 = HTMLElementUtils.createElement({
    kind: "label",
    id: generated + "sortby-desc-label",
    extraAttributes: { for: generated + "_sortby-desc" },
  });
  label0121.innerText = "Use descending order";

  col10 = HTMLElementUtils.createColumn({ width: 6 });
  label101 = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: { class: "form-check-label", for: generated + "_z-order" },
  });
  label101.innerHTML = "Z-order value:&nbsp;";
  input102 = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_z-order",
    extraAttributes: {
      class: "form-text-input",
      type: "number",
      value: 1,
...
interfaceUtils._mGenUIFuncs.generateAdvancedTooltipAccordion3 = function () {
  ...
  label0002 = HTMLElementUtils.createElement({
    ...
    extraAttributes: {
      class: "form-check-label",
      for: generated + "_tooltip_fmt",
    },
  });
  label0002.innerHTML = "Format:&nbsp;";
  inputsizefactor = HTMLElementUtils.createElement({
    kind: "input",
    id: generated + "_tooltip_fmt",
    extraAttributes: { class: "form-text-input", type: "text", value: "" },
  });
...
interfaceUtils._mGenUIFuncs.generateRowOptionsButtons = function () {
  ...
  button020 = HTMLElementUtils.createButton({
    id: generated + "_update-view-button",
    innerText: "Update view",
    class: " btn btn-primary my-1",
    eventListeners: {
      click: (event) =>
        dataUtils.updateViewOptions(event.target.id.split("_")[0]),
    },
  });
 ...
 */
interfaceUtils._mGenUIFuncs.fillDropDownsIfExpectedCSV = function (
  uid,
  expectedHeader
) {
 ...
 * @summary If somehow there is an expect CSV this will help you del with that
 */
interfaceUtils._mGenUIFuncs.fillRadiosAndChecksIfExpectedCSV = function (
  uid,
  expectedRadios
) {
  //expected headr is an object that has these keys, other will be ignored;
...
interfaceUtils._mGenUIFuncs.groupUI = async function (uid, force) {
  ...
  if (
    force === undefined &&
    Object.keys(data_obj["_groupgarden"]).length > 3000
  ) {
    let _confirm = await interfaceUtils.confirm(
      "You are trying to load " +
        Object.keys(data_obj["_groupgarden"]).length +
        " different groups, which can be slow and make TissUUmaps unresponsive. Are you sure you want to continue?",
      "Warning"
    );
    if (_confirm) {
  ...
  var _selectedOptions =
    interfaceUtils._mGenUIFuncs.areRadiosAndChecksChecked(uid);
  ...
  var filter = HTMLElementUtils.createElement({
    kind: "input",
    extraAttributes: {
  ...
  var table = HTMLElementUtils.createElement({
    kind: "table",
  ...
  if (data_obj["_gb_col"]) {
    ...
    var tr = HTMLElementUtils.createElement({
      kind: "tr",
      extraAttributes: { class: "sorttable_nosort" },
    });
    ...
    check0.addEventListener("input", (event) => {
      ...
      for (var i = 0; i < clist.length; ++i) {
        clist[i].checked = event.target.checked;
      }
    });
    var label1 = HTMLElementUtils.createElement({
      kind: "label",
      extraAttributes: { for: uid + "_all_check", class: "cursor-pointer" },
    });
    ...
    if (usename) {
      ...
      var label15 = HTMLElementUtils.createElement({
        kind: "label",
        extraAttributes: { for: uid + "_all_check", class: "cursor-pointer" },
      });
    ...
    var label17 = HTMLElementUtils.createElement({
      kind: "label",
      extraAttributes: { for: uid + "_all_check", class: "cursor-pointer" },
    });
  ...
  for (i of Object.keys(data_obj["_groupgarden"]).sort()) {
    ...
    var escapedName = "";
    if (usename) escapedName = tree["treeName"];
    ...
    var tr = HTMLElementUtils.createElement({
      ...
      extraAttributes: {
        "data-uid": uid,
        "data-escapedID": escapedID,
        "data-key": tree["treeID"],
      },
    });
    //first spot for a check
    var td0 = HTMLElementUtils.createElement({ kind: "td" });
    var td1 = HTMLElementUtils.createElement({ kind: "td" });
    var td15 = null;
    var td17 = HTMLElementUtils.createElement({
      kind: "td",
      extraAttributes: { sorttable_customkey: -dataUtils._quadtreeSize(tree) },
    });
    var td2 = null;
    var td3 = null;
    var td4 = HTMLElementUtils.createElement({ kind: "td" });
    ...
    const lastCheck0 = interfaceUtils.getElementById(
      uid + "_" + escapedID + "_check",
      false
    );
    const lastCheck1 = interfaceUtils.getElementById(
      uid + "_" + escapedID + "_hidden",
      false
    );

    var check0 = HTMLElementUtils.createElement({
      kind: "input",
      id: uid + "_" + escapedID + "_check",
      extraAttributes: {
        class: "form-check-input " + uid + "-marker-input",
        type: "checkbox",
      },
    });
    ...
    var check1 = HTMLElementUtils.createElement({
      kind: "input",
      id: uid + "_" + escapedID + "_hidden",
      extraAttributes: {
        class:
          "form-check-input marker-hidden d-none " + uid + "-marker-hidden",
        type: "checkbox",
      },
    });
    ...
    if (!data_obj["_shape_col"] && !data_obj["_pie_col"]) {
      ...
      var shapeoptions = [];
      markerUtils._symbolStrings.forEach((sho, index) => {
        shapeoptions.push({
          text: markerUtils._symbolUnicodes[index],
          value: sho,
        });
      });
      shapeinput2 = HTMLElementUtils.selectTypeDropDown({
        id: uid + "_" + escapedID + "_shape",
        class: "form-select form-select-sm " + uid + "-marker-shape",
        options: shapeoptions,
        extraAttributes: { "aria-label": ".form-select-sm" },
      });
      if (_selectedOptions["shape_fixed"]) {
        ...
        shapeinput2.value =
          markerUtils._symbolStrings[favouriteShapes[countShape]];
        countShape += 1;
        countShape = countShape % favouriteShapes.length;
      } else if (_selectedOptions["shape_gr_dict"]) {
        try {
          val = JSON.parse(_selectedDropDown["shape_gr_dict"].value)[
            tree["treeID"]
          ];
          if (val !== undefined) {
    ...
    if (!data_obj["_cb_col"] && !data_obj["_pie_col"]) {
      ...
      var colorinput3 = HTMLElementUtils.inputTypeColor({
        id: uid + "_" + escapedID + "_color",
        class: uid + "-marker-color",
        extraAttributes: { value: thecolor },
      });
      tr.appendChild(td3);
    ...
    button1 = HTMLElementUtils.createElement({
      kind: "div",
      extraAttributes: {
        "data-uid": uid,
        "data-escapedID": escapedID,
  ...
  filter.addEventListener("input", function (event) {
    ...
    const isFoundInTds = (td) =>
      regex.test(td.querySelector("label")?.innerText ?? "");
...
interfaceUtils.updateColorDict = function (uid) {
  ...
  for (i in data_obj["_groupgarden"]) {
    var tree = data_obj["_groupgarden"][i];
    var escapedID = tree["treeID"].replace(/ /g, "_");
    var colorInput = interfaceUtils.getElementById(
      uid + "_" + escapedID + "_color"
    );
    jsonDict[tree["treeID"]] = colorInput.value;
  }
  var colorDictInput = interfaceUtils.getElementById(
    uid + "_cb-bygroup-dict-val"
  );
...
interfaceUtils.updateShapeDict = function (uid) {
  ...
  for (i in data_obj["_groupgarden"]) {
    var tree = data_obj["_groupgarden"][i];
    var escapedID = tree["treeID"].replace(/ /g, "_");
    var shapeInput = interfaceUtils.getElementById(
      uid + "_" + escapedID + "_shape"
    );
    jsonDict[tree["treeID"]] = shapeInput.value;
  }
  var shapeDictInput = interfaceUtils.getElementById(
    uid + "_shape-bygroup-dict-val"
  );
  ...
  var colorDictRadio2 = interfaceUtils.getElementById(
    uid + "_shape-bygroup-dict"
  );
...
interfaceUtils._mGenUIFuncs.getGroupInputs = function (uid, key) {
  ...
  if (data_obj["_groupgarden"].hasOwnProperty(key)) {
    ...
    const hasGroupUI = interfaceUtils.getElementById(
      uid + "_" + escapedID + "_check"
    );

    if (hasGroupUI) {
      inputs["visible"] = interfaceUtils.getElementById(
        uid + "_" + escapedID + "_check"
      ).checked;
      inputs["hidden"] = interfaceUtils.getElementById(
        uid + "_" + escapedID + "_hidden"
      ).checked;
      if (
        interfaceUtils.getElementById(uid + "_" + escapedID + "_shape", false)
      )
        inputs["shape"] = interfaceUtils.getElementById(
          uid + "_" + escapedID + "_shape"
        ).value;
      if (
        interfaceUtils.getElementById(uid + "_" + escapedID + "_color", false)
      )
        inputs["color"] = interfaceUtils.getElementById(
          uid + "_" + escapedID + "_color"
        ).value;
    }
  }
...
interfaceUtils.loadingModal = function (text, title) {
  ...
  content = HTMLElementUtils.createElement({
    kind: "p",
...
interfaceUtils.confirm = function (text, title) {
  return new Promise((resolve, reject) => {
    ...
    button2 = HTMLElementUtils.createButton({
      extraAttributes: {
...
interfaceUtils.prompt = function (text, value, title, type) {
  return new Promise((resolve, reject) => {
    ...
    if (type === undefined) {
      input112 = HTMLElementUtils.createElement({
        kind: "input",
        id: "confirmModalValue",
        extraAttributes: {
          class: "form-text-input form-control",
          type: "text",
          value: value,
...
interfaceUtils.generateModal = function (
  title,
  content,
  buttons,
  uid,
...
interfaceUtils.createDownloadDropdown = function (
  downloadRow,
  innerText,
  callback,
  comment,
  ...
  DownloadDropdown.setAttribute(
    "data-placeholder",
    "Select from list (" + dropdownOptions.length + " items)"
  );
  ...
  var timer = null;
  $(".select2-select_" + random_select2_id)
    .select2({
      ...
      ajax: {
        ...
        transport: function (params, success, failure) {
          ...
          timer = setTimeout(function () {
            timer = null;
            let results = dropdownOptions.filter(function (f) {
...
interfaceUtils.createDownloadDropdownMarkers = function (options) {
  ...
  interfaceUtils._mGenUIFuncs.generateUUID();
  if (!options.uid) options.uid = interfaceUtils._mGenUIFuncs.ctx.aUUID;
  ...
  row = interfaceUtils.createDownloadDropdown(
    downloadRow,
    options.title,
    callback,
    options.comment,
  ...
  if (options.autoLoad) {
    ...
    $(row)
      ...
      .select2("trigger", "select", {
        data: {
          id: dropdownOptions[indexLoad].id,
          text: dropdownOptions[indexLoad].text,
        },
      });
  }
};

interfaceUtils.createDownloadButton = function (
  downloadRow,
  innerText,
  callback,
  comment
...
interfaceUtils.createDownloadButtonMarkers = function (options) {
  ...
  var buttonRow = interfaceUtils.createDownloadButton(
    downloadRow,
    options.title,
    callback,
    options.comment
...
interfaceUtils.createDownloadDropdownRegions = function (options) {
  ...
  interfaceUtils.createDownloadDropdown(
    downloadRow,
    options.title,
    callback,
    options.comment,
...
interfaceUtils.addMenuItem = function (itemTree, callback, before) {
  ...
  for (var i = 0; i < itemTree.length; i++) {
    ...
    if (!document.getElementById(itemID)) {
      liItem = HTMLElementUtils.createElement({
        kind: "li",
        extraAttributes: { class: "nav-item dropdown" },
      });
      if (i == 0)
        rootElement.insertBefore(
          liItem,
          document.getElementById("nav-item-title")
        );
      else if (before) rootElement.prepend(liItem);
      else rootElement.append(liItem);

      if (i == 0 && i == itemTree.length - 1) {
        aElement = HTMLElementUtils.createElement({
          kind: "a",
          id: "a_" + itemID,
          extraAttributes: { class: "nav-link active", href: "#" },
        });
        ...
        liItem.appendChild(aElement);
        ulItem = HTMLElementUtils.createElement({
          kind: "ul",
          id: itemID,
          extraAttributes: { class: "dropdown-menu dropdown-submenu" },
        });
...
interfaceUtils.addPluginAccordion = function (pluginID, pluginName) {
  ...
  var accordion_item = document.getElementById(
    "PluginAccordionItem-" + pluginID
  );
  if (!accordion_item) {
...
interfaceUtils._rGenUIFuncs.createTable = function () {
  let allRegionClasses = Object.values(regionUtils._regions).map(function (e) {
    return e.regionClass;
  });
  let singleRegionClasses = allRegionClasses.filter(
    (v, i, a) => a.indexOf(v) === i
  );
  //I do this to know if I have name selected, and also to know where to draw the
  //color from
  ...
  var label2 = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: { for: "regionUI_all_check", class: "cursor-pointer" },
  });
  label2.innerText = "All";
  td2.appendChild(label2);

  var label3 = HTMLElementUtils.createElement({
    kind: "label",
    extraAttributes: { for: "regionUI_all_check", class: "cursor-pointer" },
  });
  ...
  regionsdeletebutton.addEventListener("click", function () {
    interfaceUtils
      .confirm("Are you sure you want to delete all regions?")
      .then(function (_confirm) {
        if (_confirm) {
  ...
  for (i of Object.keys(singleRegionClasses.sort())) {
    ...
    var td0 = HTMLElementUtils.createElement({
      ...
      extraAttributes: {
        ...
        class:
          "collapse_button_regionClass collapse_button_transform collapsed",
    ...
    if (regionClass) rClass = regionClass;
    else rClass = "";
    ...
    regionclasstext.addEventListener("change", function () {
      ...
      for (region of groupRegions) {
        ...
        if (document.getElementById(escapedRegionID + "_class_ta"))
          document.getElementById(escapedRegionID + "_class_ta").value =
            newClass;
    ...
    var label3 = HTMLElementUtils.createElement({
      kind: "label",
      extraAttributes: {
        for: "regionUI_" + regionClassID + "_check",
        class: "cursor-pointer",
      },
    });
    ...
    let lastColor = interfaceUtils.getElementById(
      "regionUI_" + regionClassID + "_color",
      false
    );
    if (lastColor == null) {
      let groupRegions = Object.values(regionUtils._regions).filter(
    ...
    var check0 = HTMLElementUtils.createElement({
      kind: "input",
      id: "regionUI_" + regionClassID + "_check",
      extraAttributes: {
    ...
    regionsdeletebutton.addEventListener("click", function () {
      interfaceUtils
        .confirm(
          "Are you sure you want to delete the whole " + regionClass + " group?"
        )
        .then(function (_confirm) {
          if (_confirm) {
            groupRegions = Object.values(regionUtils._regions)
              .filter((x) => x.regionClass == regionClass)
              .forEach(function (region) {
    ...
    var tbody_subregions = HTMLElementUtils.createElement({
      kind: "tbody",
      id: "tbody_subregions_" + regionClassID,
    });
    ...
    $(collapse_div).on("show.bs.collapse", function () {
      ...
      let tbody_subregions = document.getElementById(
        "tbody_subregions_" + selectedRegionClassID
      );
      ...
      if (tbody_subregions.innerHTML == "") {
        ...
        for (region of subGroupRegions) {
          regionDetails.appendChild(
            interfaceUtils._rGenUIFuncs.createRegionRow(region.id)
          );
        }
...
interfaceUtils._rGenUIFuncs.createRegionRow = function (regionId) {
  ...
  regionshistobutton.addEventListener("click", function () {
    ...
    interfaceUtils.alert(innerHTML, "Region statistics");
  });
  ...
  var check0 = HTMLElementUtils.createElement({
    kind: "input",
    id: "singleRegionUI_" + escapedRegionId + "_check",
    extraAttributes: {
      class:
  ...
  tr.onmouseover = function () {
    ...
    const viewportPoints = regionUtils.globalPointsToViewportPoints(
      region.globalPoints,
    ...
    d3.selectAll("#" + escapedRegionId + "_poly").classed(
      "regionUI-region-hover",
      true
    );
  };
