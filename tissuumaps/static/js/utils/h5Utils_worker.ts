  ...
  if (action === "load") {
    ...
    if (typeof url === "string" || url instanceof String) {
      ...
      try {
        ...
        h5wasm.FS.createLazyFile(
          "/",
          "current_file_without_range" + id + ".h5",
          url,
          true,
          false
        );
    ...
    if (file[url]) {
      ...
      if (item instanceof h5wasm.Group) {
        ...
        item instanceof h5wasm.BrokenSoftLink ||
        item instanceof h5wasm.ExternalLink
      ) {
